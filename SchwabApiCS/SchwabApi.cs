...
namespace SchwabApiCS
{
    ...
    public partial class SchwabApi
    {
        ...
        {
           ContractResolver = new IgnoreReadOnlyContractResolver() // <-- Add this line
        };

        internal class IgnoreReadOnlyContractResolver : Newtonsoft.Json.Serialization.DefaultContractResolver
        {
            protected override Newtonsoft.Json.Serialization.JsonProperty CreateProperty(System.Reflection.MemberInfo member, Newtonsoft.Json.MemberSerialization memberSerialization)
            {
                ...
                // If the property cannot be written to (no setter), tell Newtonsoft to skip it
        ...
        public SchwabApi(string TokenFile)
        {
            lock (lockobj)
            {
                SchwabApi.schwabTokens = new SchwabTokens(TokenFile);
        ...
        public class ApiResponseWrapper<T>
        {
            ...
            public ApiResponseWrapper(T data, bool hasError, HttpResponseMessage? responseMessage, Exception? apiException = null)
            {
                ...
                {
                    var ex = apiException.InnerException;
                    this.HasError = hasError;
      ...
      new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc);
        ...
        {
            return UnixEpochUtc.AddMilliseconds(schwabTime);
        }
        ...
        public static long DateTime_to_ApiDateTime(DateTime dateTime)
        {
            ...
            TimeSpan ts = dateTime.ToUniversalTime() - UnixEpochUtc;
